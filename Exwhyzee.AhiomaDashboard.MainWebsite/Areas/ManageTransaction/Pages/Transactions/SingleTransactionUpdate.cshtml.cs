...
{
    public class SingleTransactionUpdateModel : PageModel
    {
        ...
        public SingleTransactionUpdateModel(
        ...
        public async Task<IActionResult> OnGetAsync(long id, long tId)
        {
            ...
            IQueryable<Transaction> itransaction = from s in _context.Transactions
             ...
             .Where(x => x.OrderItemId == id)
                                                   select s;
            Transaction = await itransaction.FirstOrDefaultAsync(x => x.Id == tId);
            return Page();
        ...
        public async Task<IActionResult> OnPostAsync()
        {
                ...
                var item = await _context.Transactions.FirstOrDefaultAsync(x => x.Id == TId);
