...
namespace Exwhyzee.AhiomaDashboard.MainWebsite.Areas.Identity.Pages.Account.Manage
{
    ...
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public EnableAuthenticatorModel(AhiomaDbContext context,
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(IdentityUser user)
        {
            ...
            var info = profile.Fullname + " [" + profile.IdNumber + "]";
            AuthenticatorUri = GenerateQrCodeUri(info, unformattedKey);
        }
