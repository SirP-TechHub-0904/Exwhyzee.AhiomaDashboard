...
{
    public class SeedAddFundModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string returnUrl = null)
        {
            ...
            var user = new IdentityUser { UserName = "addfund@ahioma.com", Email = "addfund@ahioma.com", PhoneNumber = "09000000000000", LockoutEnabled = false };
            ...
            if (result.Succeeded)
            {
                ...
                profile.Surname = "Ahioma";
                profile.FirstName = "AddFund";
