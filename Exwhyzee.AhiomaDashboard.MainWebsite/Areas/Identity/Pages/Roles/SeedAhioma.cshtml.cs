...
{
    public class SeedAhiomaModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string returnUrl = null)
        {
            ...
            var user = new IdentityUser { UserName = "ahiomaorder@ahioma.com", Email = "ahiomaorder@ahioma.com", PhoneNumber = "000000000000", LockoutEnabled = false };
