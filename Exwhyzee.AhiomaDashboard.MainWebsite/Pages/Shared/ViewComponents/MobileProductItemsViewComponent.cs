...
{
    public class MobileProductItemsViewComponent : ViewComponent
    {
        private readonly AhiomaDbContext _context;
        private readonly IHostingEnvironment _hostingEnv;
        public MobileProductItemsViewComponent(AhiomaDbContext context, IHostingEnvironment hostingEnv)
        {
            _context = context;
       ...
       public IQueryable<Product> Product { get; set; }
        ...
        public async Task<IViewComponentResult> InvokeAsync(long id)
        {
            ...
            NewProductList = NewProductList.Where(x => x.ImageThumbnail != "noimage").OrderBy(a => Guid.NewGuid()).Take(6);
