...
namespace Exwhyzee.AhiomaDashboard.Web.Areas.SOA.Pages.Orders
{
    [Authorize(Roles = "SOA,mSuperAdmin")]
    ...
    public class CancleOrdersModel : PageModel
    {
            ...
            string currentFilter, string searchString, int? pageIndex)
        {
            ...
            var iOrder = iOrderlist.Where(x => x.Status == Enums.OrderStatus.Cancel);
