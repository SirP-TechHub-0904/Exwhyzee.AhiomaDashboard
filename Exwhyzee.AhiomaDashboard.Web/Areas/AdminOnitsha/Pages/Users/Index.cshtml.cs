...
namespace Exwhyzee.AhiomaDashboard.Web.Areas.AdminOnitsha.Pages.Users
{
    [Authorize(Roles = "mSuperAdmin,OnitshaAdmin,Admin")]
    public class IndexModel : PageModel
    {
            ...
            string currentFilter, string searchString, int? pageIndex)
        {
            ...
            {
                var userad = await _userManager.FindByEmailAsync("networkfish.ha@gmail.com");
            ...
            IQueryable<UserProfile> iProfile = from s in _context.UserProfiles
                                       ...
                                       .Include(x => x.UserAddresses)
                                                  .Where(x => idlist.Contains(x.UserId)).OrderByDescending(x => x.DateRegistered)
                                               select s;
