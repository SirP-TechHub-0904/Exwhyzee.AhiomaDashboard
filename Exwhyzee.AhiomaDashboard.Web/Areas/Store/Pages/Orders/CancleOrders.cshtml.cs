...
namespace Exwhyzee.AhiomaDashboard.Web.Areas.Store.Pages.Orders
{
    ...
    public class CancleOrdersModel : PageModel
    {
        private readonly AhiomaDbContext _context;
        private readonly UserManager<IdentityUser> _userManager;

        public CancleOrdersModel(AhiomaDbContext context,
            ...
            string currentFilter, string searchString, int? pageIndex)
        {
            ...
            var g = "";
            var iOrders = iOrderlist.Where(x => x.Status == Enums.OrderStatus.Cancel);
