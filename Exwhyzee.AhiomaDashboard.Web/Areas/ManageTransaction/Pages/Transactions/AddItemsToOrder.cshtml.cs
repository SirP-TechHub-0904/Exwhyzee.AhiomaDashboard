...
namespace Exwhyzee.AhiomaDashboard.Web.Areas.ManageTransaction.Pages.Transactions
{
    ...
    public class AddItemsToOrderModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAddProduct()
        {
            ...
            decimal? orderamt = order.AmountPaid - order.LogisticAmount;
            decimal? diff = (orderamt + (order.AdditionalPayment)) - order.OrderCostAfterProcessing - order.AmountMovedToCustomer + order.AmountMovedToAdmin;
