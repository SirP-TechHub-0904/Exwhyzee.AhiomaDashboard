       ...
       public OrderItem OrderItem { get; set; }
        public async Task<IActionResult> OnGetAsync(long id)
        {
            ...
            try
            {
                ...
                if(iOrderItem.ShopStatus == ShopStatus.Pending)
                {
                    iOrderItem.ShopStatus = ShopStatus.Successful;
                }
                else if (iOrderItem.ShopStatus == ShopStatus.Cancel)
                {
                    iOrderItem.ShopStatus = ShopStatus.Successful;
                }
                else if (iOrderItem.ShopStatus == ShopStatus.None)
                {
                    iOrderItem.ShopStatus = ShopStatus.Successful;
                }
                else
                {
                    iOrderItem.ShopStatus = ShopStatus.Pending;
                }
